...
For the full end-to-end PQC workflow used in this repository (data preparation, encoding, PQC training, stress sweeps, finalist export, and notebook scoring), see [README_PIPELINE.md](README_PIPELINE.md).
